...
if (new Date - user.lastclaim < 7200000) return await conn.reply(m.chat, `𝚈𝙰 𝚁𝙴𝙲𝙻𝙰𝙼𝙰𝚂𝚃𝙴 𝚃𝚄 𝚁𝙴𝙶𝙰𝙻𝙾 🎁\n𝚅𝚄𝙴𝙻𝚅𝙴 𝙴𝙽 _*${msToTime(time - new Date())}*_ 𝙿𝙰𝚁𝙰 𝚅𝙾𝙻𝚅𝙴𝚁 𝙰 𝚁𝙴𝙲𝙻𝙰𝙼𝙰𝚁`, fkontak,  m)
