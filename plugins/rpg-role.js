    ...
    '*DIAMANTE V* 💎': 35,
     '*DIAMANTE IV* 💎': 36,
      '*DIAMANTE III* 💎': 37,
       '*DIAMANTE II* 💎': 38,
        '*DIAMANTE I* 💎': 39,
    '*PRO EN MAKANAKAYBOT V* 😼': 40,
     '*PRO EN MAKANAKAYBOT IV* 😼': 41,
      '*PRO EN MAKANAKAYBOT III* 😼': 42,
       '*PRO EN MAKANAKAYBOT II* 😼': 43,
        '*PRO EN MAKANAKAYBOT I* 😼': 44,
    '*SUPER PRO V* 🎩': 45,
     '*SUPER PRO IV* 🎩': 46,
      '*SUPER PRO III* 🎩': 47,
       '*SUPER PRO II* 🎩': 48,
                                                                                        ...
                                                                                        : ((user.level >= 63) && (user.level <= 66)) ? '*DIAMANTE III* 💎'
                                                                                            : ((user.level >= 66) && (user.level <= 69)) ? '*DIAMANTE II* 💎'
                                                                                                : ((user.level >= 69) && (user.level <= 71)) ? '*DIAMANTE I* 💎'
                                                                                                    : ((user.level >= 71) && (user.level <= 74)) ? '*PRO EN MAKANAKAYBOT III* 😼'
                                                                                                        : ((user.level >= 74) && (user.level <= 77)) ? '*PRO EN MAKANAKAYBOT II* 😼'
                                                                                                            : ((user.level >= 77) && (user.level <= 80)) ? '*PRO EN MAKANAKAYBOT I* 😼'
