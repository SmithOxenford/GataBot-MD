...
if (new Date - user.lasthourly < 3600000) return await conn.reply(m.chat, `𝚈𝙰 𝚁𝙴𝙲𝙸𝙱𝙸𝚂𝚃𝙴 𝚃𝚄 𝙴𝙽𝚃𝚁𝙴𝙶𝙰 𝙳𝙴 𝙲𝙰𝙳𝙰 𝙷𝙾𝚁𝙰 ♻️\n𝚅𝚄𝙴𝙻𝚅𝙴 𝙴𝙽 *${msToTime(time - new Date())}* 𝙿𝙰𝚁𝙰 𝚁𝙴𝙲𝙸𝙱𝙸𝚁 𝙾𝚃𝚁𝙰 𝙴𝙽𝚃𝚁𝙴𝙶𝙰`, fkontak,  m)
