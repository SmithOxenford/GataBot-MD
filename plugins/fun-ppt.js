...
let money0 = global.db.data.users[m.sender].money += 2
 ...
 await conn.reply(m.chat, `╭━━━━[ 𝙀𝙈𝙋𝘼𝙏𝙀! 🤝 ]━━━━⬣\n┃${name} 𝙐𝙨𝙩𝙚𝙙: ${text}\n┃ 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘽𝙤𝙩: ${astro}\n┃💸 𝘽𝙤𝙣𝙤: $${[money0].getRandom()} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n┃💵 𝙎𝙪 𝘿𝙞𝙣𝙚𝙧𝙤: $${money} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n╰━━━━━━[ 𝙏𝙃𝙀 𝙈𝘼𝙆𝘼𝙉𝘼𝙆𝙔 - 𝘽𝙊𝙏 ]━━━━━⬣`, fkontak, m)
...
await conn.reply(m.chat, `╭━━━━[ 𝙃𝘼 𝙂𝘼𝙉𝘼𝘿𝙊! 🎉 ]━━━⬣\n┃${name} 𝙐𝙨𝙩𝙚𝙙: ${text}\n┃ 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘽𝙤𝙩: ${astro}\n┃💰 𝙋𝙧𝙚𝙢𝙞𝙤: $${[money0].getRandom()} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n┃💵 𝙎𝙪 𝘿𝙞𝙣𝙚𝙧𝙤: $${money} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n╰━━━━━━[ 𝙏𝙃𝙀 𝙈𝘼𝙆𝘼𝙉𝘼𝙆𝙔 - 𝘽𝙊𝙏 ]━━━━━⬣`, fkontak, m)
...
await conn.reply(m.chat, `╭━━━━[ 𝙃𝘼 𝙋𝙀𝙍𝘿𝙄𝘿𝙊! 🤡 ]━━⬣\n┃${name} 𝙐𝙨𝙩𝙚𝙙: ${text}\n┃ 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘽𝙤𝙩: ${astro}\n┃📈 𝙋𝙚𝙧𝙙𝙞𝙙𝙖: $${[money0].getRandom()} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n┃💵 𝙎𝙪 𝘿𝙞𝙣𝙚𝙧𝙤: $${money} 𝙈𝙖𝙠𝙖𝙣𝙖𝙠𝙮𝘾𝙤𝙞𝙣𝙨\n╰━━━━━━[ 𝙏𝙃𝙀 𝙈𝘼𝙆𝘼𝙉𝘼𝙆𝙔 - 𝘽𝙊𝙏 ]━━━━━⬣`, fkontak, m)
