...
if (/^A Bueno adiós master|A bueno adiós master|adiós master|🫂$/i.test(m.text) && chat.audios) {  
...
if (chat.audios && m.text.match(/(El Toxico|El tóxico|Toxico|tóxico)/gi)) {    
let vn = './media/El Toxico.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Elmo sabe donde vives|Elmo sabe dónde vives|donde vives|Donde vives|Donde Vives)/gi)) {    
...
if (chat.audios && m.text.match(/(Me anda buscando anonymous|me anda buscando anonymous|Me está buscando anonymous|me está buscando anonymous|Me está buscando anonimo|Me esta buscando anonimo)/gi)) {    
...
if (chat.audios && m.text.match(/(Rompas más mi corazón|No Rompas mi corazon|no rompas mi corazón|no rompas mi ❤️)/gi)) {    
let vn = './media/No Rompas Mas.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(tiste|toste|tite|triste|Triste|😞|😔)/gi)) {    
...
if (chat.audios && m.text.match(/(Que tal Grupo|qué tal grupo|como están en el grupo|como esta el grupo)/gi)) {    
let vn = './media/Que tal Grupo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Se están riendo de mí|Se estan riendo de mi|Se esta riendo de mi|Se está riendo de mi|es feak|es fake|Es fake)/gi)) {    
...
if (chat.audios && m.text.match(/(Te gusta el Pepino|🥒|🍆|nepe|pepino|Pepino)/gi)) {    
...
if (chat.audios && m.text.match(/(bañate|Bañate|pegate un baño|baño|ducha|bañar)/gi)) {    
...
if (chat.audios && m.text.match(/(No, bueno si|no, bueno si|no, bueno sí|No, bueno sí)/gi)) {    
...
if (chat.audios && m.text.match(/(diagnosticadocongay|diagnosticado con gay|diagnosticado gay|te diagnóstico con gay|diagnóstico gay|te diagnostico con gay|te diagnóstico con gay|te diagnosticó con gay|te diagnostico con gay)/gi)) {    
...
if (chat.audios && m.text.match(/(EPICA|Epico|épico)/gi)) {    
let vn = './media/entrada-epica-al-chat.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(esto va ser epico|Esto va ser épico papus|esto va ser épico papus)/gi)) {    
...
if (chat.audios && m.text.match(/(feliz cumpleaños|felizcumpleaños|happy birthday|Feliz cumpleaños)/gi)) {    
...
if (chat.audios && m.text.match(/(Fino señores|fino señores|Fino senores|fino senores|fino|Fino)/gi)) {    
let vn = './media/fino-senores.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(flash|teletransportación)/gi)) {    
...
if (chat.audios && m.text.match(/(Hablen carajo en el grupo|escriban coño|empiezen a escribir muertos)/gi)) {    
...
if (chat.audios && m.text.match(/(Quién es tu senpai|Quien es tu senpai|Quién es tu sempai|Quien es tu sempai|Quién es tu senpai botsito 7w7|Quien es tu senpai botsito 7w7|quién es tu senpai|quien es tu senpai|Quién es tu sempai botsito 7w7|Quien es tu sempai botsito 7w7|Quién es tu senpai botsito|Quien es tu senpai botsito|Quién es tu sempai botsito|Quien es tu sempai botsito|Quién es tu senpai botsito|Quien es tu senpai botsito|quién es tu senpai botsito|quien es tu senpai botsito|Quién es tu sempai botsito|Quien es tu sempai botsito)/gi)) {    
let vn = './media/Tu.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(salte del grupo|me voy del grupo|me saldré del grupo|salió del grupo|Salió del grupo)/gi)) {
...
if (chat.audios && m.text.match(/(es puto|es putísimo|Es puto)/gi)) {
...
let vn = './media/no la pienso.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(loli conmigo venga|abusado|loli venir)/gi)) {
let vn = './media/loli conmigo.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = './media/soy guapo.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(Dj bot|dj bot)/gi)) {
let vn = './media/dj bot.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(quevedo quedate|quedate|bot poner un temazo|quevedo)/gi)) {
let vn = './media/quedate.mp3'//qno hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(la gallina para que cruzó la calle)/gi)) {    
...
if (chat.audios && m.text.match(/(se re pudrió|se que re pudrió)/gi)) {    
...
let vn = './media/el amor.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(estupido|estupido|Estúpido|estúpido)/gi)) {    
let vn = './media/estupido.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(mi bebito fiu|fiu fiu|caramelo|Caramelo|caramelito|vizcarra|Martín Vizcarra)/gi)) {    
let vn = './media/fui.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(no soy pati|no soy pati)/gi)) {    
let vn = './media/no soy pati.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(oxxo|oxxo mmm)/gi)) {    
let vn = './media/oxxo.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(sexo anak|Sexo anal|Hora de sexo anal|hora de sexo anal)/gi)) {    
let vn = './media/maau1.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = './media/sabosito.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(mañana no trabajo|Mañana no trabajo)/gi)) {    
let vn = './media/trabajo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(mami yo que digo a ti)/gi)) {    
let vn = './media/mami yo que digo a ti.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(Mujerrrrrrrrrrrrrr)/gi)) {    
let vn = './media/mujer.mp3'//no hay canción
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(violinnnnn)/gi)) {    
