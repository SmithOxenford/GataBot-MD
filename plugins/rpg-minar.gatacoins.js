...
if (new Date - user.lastcoins < 600000) return await conn.reply(m.chat, `⏱️ 𝚅𝚄𝙴𝙻𝚅𝙰 𝙴𝙽 ${msToTime(time - new Date())} 𝙿𝙰𝚁𝙰 𝙲𝙾𝙽𝚃𝙸𝙽𝚄𝙰𝚁 𝙼𝙸𝙽𝙰𝙽𝙳𝙾 ${global.rpgshopp.emoticon('money')}⛏️`, fkontak,  m)
