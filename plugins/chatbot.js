...
if (/^e$/i.test(m.text) ) { //sem prefixo
    let teks = `
${pickRandom([`𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙴 😮`, `𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙴 😮`])}
`.trim()
conn.reply(m.chat, teks, m, { mentions: { mentionedJid: [m.sender] }})

}

if (/^i$/i.test(m.text) ) { //sem prefixo
    let teks = `
${pickRandom([`𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙸 😮`, `𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙸 😮`])}
`.trim()
conn.reply(m.chat, teks, m, { mentions: { mentionedJid: [m.sender] }})

}

if (/^o$/i.test(m.text) ) { //sem prefixo
    let teks = `
${pickRandom([`𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙾 😮`, `𝚀𝚄𝙴 𝙱𝚄𝙴𝙽𝙾 𝚂𝙰𝙱𝙴 𝙻𝙰 𝙻𝙴𝚃𝚁𝙰 𝙾 😮`])}
`.trim()
conn.reply(m.chat, teks, m, { mentions: { mentionedJid: [m.sender] }})

}

if (/^u$/i.test(m.text) ) { //sem prefixo
    let teks = `
${pickRandom([`𝙴𝙻/𝙻𝙰 𝚅𝙴𝙽𝙰𝙳𝙾(𝙰) 𝙴𝚁𝙴𝚂 𝚃𝚄́ 🦌`, `𝙴𝙻/𝙻𝙰 𝚅𝙴𝙽𝙰𝙳𝙾(𝙰) 𝙴𝚁𝙴𝚂 𝚃𝚄́ 🦌`])}
`.trim()
conn.reply(m.chat, teks, m, { mentions: { mentionedJid: [m.sender] }})
...
if (/^¿que es un bot?|Que es un bot|Que Es Un Bot|que es un bot$/i.test(m.text) ) { //sem prefixo
    conn.reply(m.chat, `╭┄〔 𝐀𝐂𝐀́ 𝐄𝐒𝐓𝐀 𝐓𝐔 𝐑𝐄𝐒𝐏𝐔𝐄𝐒𝐓𝐀 💋〕┄⊱
┆ ——————«•»——————
┆ ¿𝐐𝐔𝐄 𝐄𝐒 𝐔𝐍 𝐁𝐎𝐓 𝐃𝐄 𝐖𝐓𝐒𝐏? 🤖
┆——————«•»——————
┆ 𝙴𝚂 𝚄𝙽𝙰 𝙸𝙽𝚃𝙴𝙻𝙸𝙶𝙴𝙽𝙲𝙸𝙰 
