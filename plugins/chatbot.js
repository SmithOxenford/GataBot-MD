...
/*if (/^Mande porno|porno|paja$/i.test(m.text) ) { //sem prefixo
    let teks = `
${pickRandom([`𝙽𝙾 𝙿𝚄𝙴𝙳𝙾, 𝙴𝚂𝚃𝙰 𝙲𝙾𝙽𝚃𝚁𝙰 𝚕𝚊 𝙿𝙾𝙻𝙸𝚃𝙸𝙲𝙰 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾.☹️`, `𝚄𝙵𝙵 𝙼𝙸𝚁𝙴𝙽 𝙰𝚄𝙽 𝙿𝙰𝙹𝙴𝚁𝙾`, `𝙿𝙰𝙶𝙰𝙼𝙴 𝚈 𝙿𝙰𝚂𝙾 𝙼𝙸 𝙿𝙰𝙲𝙺 😏🥵`, `𝚀𝚄𝙴 😳`, `𝚀𝚄𝙴 𝚀𝚄𝙸𝙴𝚁𝙴 𝙿𝙸𝙹𝙰 𝙳𝙸𝙲𝙴 🤣`, `𝙿𝙰𝚂𝙰 𝙴𝙻 𝙿𝙰𝙲𝙺 𝙳𝙴 𝚃𝚄 𝙷𝙴𝚁𝙼𝙰𝙽𝙰 😏`, `𝙼𝙸𝚁𝙴𝙽 𝚄𝙽𝙰 𝙶𝙸𝙻𝙸𝙿𝙾𝙻𝙻𝙰 🤣`, `𝚂𝙸𝚄𝚄𝚄 𝚂𝙴𝚇𝙾 𝚂𝙴𝚇𝙾 𝚂𝙴𝚇𝙾 😈`, '𝙲𝙰𝙻𝙻𝙴𝚃𝙴 𝙿𝚄𝚃𝙸𝚃𝙾 😐'])}
`.trim()
conn.reply(m.chat, teks, m, { mentions: { mentionedJid: [m.sender] }})
