...
let handler = async (m, { conn, text }) => {
    ...
    m.reply('*✅ Estado subido con exito, agenda en tu lista de contactos el número del Bot Makanaky y pide al propietario del Bot que te agregue a sus contactos para que puedas ver los estados*')
    }
