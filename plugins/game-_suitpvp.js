...
👑 𝐑𝐄𝐒𝐔𝐋𝐓𝐀𝐃𝐎𝐒 𝐃𝐄𝐋 𝐏𝐕𝐏 👑${tie ? '\n—◉ 𝐄𝐌𝐏𝐀𝐓𝐄!' : ''}
*@${room.p.split`@`[0]} (${room.text})* ${tie ? '' : room.p == win ? ` 𝐆𝐀𝐍𝐎́ 🥳 : _+${room.poin}XP_` : ` 𝐏𝐄𝐑𝐃𝐈𝐎́ 🤡 : _${room.poin_lose}XP_`}
*@${room.p2.split`@`[0]} (${room.text2})* ${tie ? '' : room.p2 == win ? ` 𝐆𝐀𝐍𝐎́ 🥳 : _+${room.poin}XP_` : ` 𝐏𝐄𝐑𝐃𝐈𝐎́ 🤡 : _${room.poin_lose}XP_`}
