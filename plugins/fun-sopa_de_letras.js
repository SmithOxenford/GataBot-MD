...
𝙴𝚂𝙲𝚁𝙸𝙱𝙰 𝙴𝙻 𝙽𝚄́𝙼𝙴𝚁𝙾 𝙳𝙴 𝙵𝙸𝙻𝙰 𝚈 𝙲𝙾𝙻𝚄𝙼𝙽𝙰 𝙳𝙴𝙻 𝙲𝙾𝙼𝙸𝙴𝙽𝚉𝙾 𝙳𝙴 𝙻𝙰 𝙿𝚁𝙸𝙼𝙴𝚁𝙰 𝙻𝙴𝚃𝚁𝙰"${PALABRA.charAt(0)}" 𝙳𝙴 𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 _"${PALABRA}"_ 𝚃𝙸𝙴𝙽𝙴 *${intentos}* 𝙸𝙽𝚃𝙴𝙽𝚃𝙾𝚂!!

𝐄𝐉𝐄𝐌𝐏𝐋𝐎 :
❇️ \`\`\`*${usedPrefix + command}* 28\`\`\`
➡️ \`\`\`_FILA 2_\`\`\`    ⬇️ \`\`\`_COLUMNA 8_\`\`\``.trim())
...
if (intentos !== 0) {
await conn.reply( m.chat, `@${m.sender.split("@")[0]} 𝙴𝙻 𝚃𝙸𝙴𝙼𝙿𝙾 𝚂𝙴 𝙷𝙰 𝙰𝙲𝙰𝙱𝙰𝙳𝙾!! 😧\n\n𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 _"${sopaPalabra}"_ 𝚂𝙴 𝙴𝙽𝙲𝙾𝙽𝚃𝚁𝙰𝙱𝙰 𝙴𝙽 𝙻𝙰 𝙳𝙸𝚁𝙴𝙲𝙲𝙸𝙾́𝙽 _${sopaDir}_ 𝙳𝙴 𝙻𝙰 𝙵𝙸𝙻𝙰 ${fila} 𝚈 𝙲𝙾𝙻𝚄𝙼𝙽𝙰 ${columna}`, m, { mentions: [m.sender] })
...
await m.reply(`\`\`\`🎊 𝐇𝐀𝐒 𝐆𝐀𝐍𝐀𝐃𝐎 ${diamante} ${rpgshop.emoticon('limit')}!!\`\`\`\n\n𝙲𝙾𝚁𝚁𝙴𝙲𝚃𝙾!! 𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 _"${sopaPalabra}"_ 𝚂𝙴 𝙴𝙽𝙲𝙾𝙽𝚃𝚁𝙰𝙱𝙰 𝙴𝙽 𝙻𝙰 𝙳𝙸𝚁𝙴𝙲𝙲𝙸𝙾́𝙽 _${cambioLetra}_ 𝙳𝙴 𝙻𝙰 𝙵𝙸𝙻𝙰 ${fila} 𝚈 𝙲𝙾𝙻𝚄𝙼𝙽𝙰 ${columna}`)
fila = null, columna = null, sopaNube = null, sopaPalabra = null, sopaDir = null, userSP = null, cambioLetra = null
intentos = 0
return
}else{
...
fila = null, columna = null, sopaNube = null, sopaPalabra = null, sopaDir = null, userSP = null, cambioLetra = null
intentos = 0
await m.reply(`𝙰𝙶𝙾𝚃𝙰𝚂𝚃𝙴 𝙻𝙾𝚂 𝙸𝙽𝚃𝙴𝙽𝚃𝙾𝚂 𝙿𝙸𝙿𝙸𝙿𝙸 ☹️ 𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 _"${sopaPalabra}"_ 𝚂𝙴 𝙴𝙽𝙲𝙾𝙽𝚃𝚁𝙰𝙱𝙰 𝙴𝙽 𝙻𝙰 𝙳𝙸𝚁𝙴𝙲𝙲𝙸𝙾𝙽 _${cambioLetra}_ 𝙳𝙴 𝙻𝙰 𝙵𝙸𝙻𝙰 ${fila} 𝚈 𝙲𝙾𝙻𝚄𝙼𝙽𝙰 ${columna}`)
return  
} else {
intentos -= 1
await m.reply(`😮‍💨 𝙸𝙽𝙲𝙾𝚁𝚁𝙴𝙲𝚃𝙾. 𝚃𝙴 𝚀𝚄𝙴𝙳𝙰𝙽 ${intentos} 𝙸𝙽𝚃𝙴𝙽𝚃𝙾𝚂! ${intentos === 1 ? '' : `\n𝙿𝙰𝙻𝙰𝙱𝚁𝙰 𝙰 𝙴𝙽𝙲𝙾𝙽𝚃𝚁𝙰𝚁: \`\`\`${sopaPalabra}\`\`\``}\n\n${intentos === 1 ? `\`\`\`💡 𝙿𝙸𝚂𝚃𝙰!!\`\`\`\n𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 _${sopaPalabra}_ 𝚂𝙴 𝙴𝙽𝙲𝚄𝙴𝙽𝚃𝚁𝙰 𝙴𝙽 𝙻𝙰 𝙳𝙸𝚁𝙴𝙲𝙲𝙸𝙾𝙽 _"${cambioLetra}"_\n\n` : ''}${sopaNube}`)
return
}}
}}
